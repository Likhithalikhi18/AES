...
HD_PWD='C:/Users/Likhitha/Desktop/MUX/shiftrows_multiplexer/shiftrows_multiplexer.runs/shiftrows_using_mux_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log shiftrows_using_mux_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source shiftrows_using_mux_0.tcl
