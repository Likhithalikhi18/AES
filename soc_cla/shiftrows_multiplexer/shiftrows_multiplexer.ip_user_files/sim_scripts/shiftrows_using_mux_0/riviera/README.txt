...
#
# Generated by export_simulation on Tue Apr 22 19:46:16 +0530 2025
#
################################################################################
...
'-reset_run' switch to the './shiftrows_using_mux_0.sh' script.

./shiftrows_using_mux_0.sh -reset_run
...
./shiftrows_using_mux_0.sh -noclean_files

For more information on the script, please type './shiftrows_using_mux_0.sh -help'.
