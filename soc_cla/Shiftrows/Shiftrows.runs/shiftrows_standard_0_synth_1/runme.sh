...
HD_PWD='C:/Users/Likhitha/Desktop/MUX/sbox_mux/sbox_mux.runs/shiftrows_standard_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log shiftrows_standard_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source shiftrows_standard_0.tcl
